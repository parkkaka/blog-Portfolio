	...
	createSkillsText() {
		this.skillsContainer.forEach((value, index) => {
			value.addEventListener('click', () => {
				switch (index) {
					case 0:
						this.divSkillDescription.textContent = '레이아웃의 구조를 이해하고 있으며 더욱 더 발전하기 위해 공부를 하고 있습니다.';
						break;
					case 1:
						this.divSkillDescription.textContent = '구조를 배치하고 효과를 줄 수 있으며 더욱 많은 효과를 위한 선택자 공부를 하고 있습니다.';
						break;
					case 2:
						this.divSkillDescription.textContent = 'ES6와 Class객체에 대한 이해가 부족하여 예제와 책을 보면서 공부를 하고 있습니다.';
						break;
					case 3:
					...
					case 4:
						...
						break;
					case 5:
						this.divSkillDescription.textContent = 'props와 state를 사용하여 값 전달을 어느 정도 이해 하고 있으며 객체형에서 함수형으로 공부를 하고 있습니다.';
						break;
					case 6:
						this.divSkillDescription.textContent = 'DB와 비동기 등을 접목 시킬 수 있으며 DB연결과 다양한 변수 및 명령어를 php net을 통해 공부를 하고 있습니다.';
						break;
					case 7:
						this.divSkillDescription.textContent = '테이블의 구성과 명령어를 이해하며 사용 할 수 있으며 다양한 명령어를 공부하고 있습니다.';
						break;
					case 8:
						this.divSkillDescription.textContent = '동적프로그램을 사용할 수 있으며 대상자 사용등을 공부하고 있습니다.';
						break;
					default:
						'';
						break;
...
const main = (() => {
	...
	const arrPortfolioGithubURL = [
		'https://github.com/parkkaka/php-mysql-portfolio',
		'https://github.com/parkkaka/Sixth-Portfolio',
		'https://github.com/parkkaka/Second-Portfolio-Clone-Coding-react',
		'https://github.com/parkkaka/First-MiniProject-React',
		'https://github.com/parkkaka/Seventh-Portfolio',
		'https://github.com/parkkaka/Fifth-Portfolio',
		'https://github.com/parkkaka/Fourth-Portfolio',
		'https://github.com/parkkaka/Third-Portfolio',
		'https://github.com/parkkaka/Second-Portfolio',
		'https://github.com/parkkaka/First-Portfolio',
	];

	const arrPortfolioURL = [
		'http://pager.kr/~c15st14/porfolio/app(php-mysql)/',
		'http://pager.kr/~c15st14/porfolio/CashRegister/',
		'https://parkkaka.github.io/Second-Portfolio-Clone-Coding-react/',
		'https://parkkaka.github.io/First-MiniProject-React/',
		'https://parkkaka.github.io/Seventh-Portfolio/',
		'https://parkkaka.github.io/Fifth-Portfolio/',
		'https://parkkaka.github.io/Fourth-Portfolio/',
		'http://pager.kr:3000/',
		'https://parkkaka.github.io/Second-Portfolio/matrix.html/',
		'https://parkkaka.github.io/First-Portfolio/html/',
	];
	...
	const portfolioMove2 = new PortfolioMove(
		arrImgThumbnail,
		arrDivPortfolioTitle,
		arrDivPersonNumber,
		arrDivDescription,
	...
	console.log(sectionContainer[0].scrollHeight);
})();
